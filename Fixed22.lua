...
function CircleClick(Button, X, Y)
	spawn(function()
		...
		FeatureImg.Image = "rbxassetid://10747383819"
...
function FlurioreLib:MakeNotify(NotifyConfig)
	...
	NotifyConfig.Title = NotifyConfig.Title or "Dragon Hub"
	NotifyConfig.Description = NotifyConfig.Description or "Notification"
	NotifyConfig.Content = NotifyConfig.Content or "Content"
	NotifyConfig.Color = NotifyConfig.Color or Color3.fromRGB(8, 152, 255)
...
function FlurioreLib:MakeGui(GuiConfig)
	...
	GuiConfig.NameHub = GuiConfig.NameHub or "Dragon Hub"
	GuiConfig.Description = GuiConfig.Description or "Comeback | developing by Dragon, Teru"
	GuiConfig.Color = GuiConfig.Color or Color3.fromRGB(8, 152, 255)
	...
	DropShadowHolder.ZIndex = 0
	DropShadowHolder.Name = "DropShadowHolder"
	DropShadowHolder.Parent = DragonGui
	
  DropShadowHolder.Position = UDim2.new(0, (DragonGui.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0, (DragonGui.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
	...
	ImageLabel1.Image = "rbxassetid://10747383819"
	...
	function GuiFunc:DestroyGui()
		if CoreGui:FindFirstChild("DragonGui") then 
			DragonGui:Destroy()
		end
	end
