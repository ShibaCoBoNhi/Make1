...
function FlurioreLib:MakeNotify(NotifyConfig)
	...
	NotifyConfig.Title = NotifyConfig.Title or "Damon Hub"
...
function FlurioreLib:MakeGui(GuiConfig)
	...
	GuiConfig.NameHub = GuiConfig.NameHub or "Damon Hub"
	GuiConfig.Description = GuiConfig.Description or "Dragon"
